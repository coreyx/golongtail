...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_GetWorkerCount(%p)", job_api)
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_ReserveJobs(%p, %u)", job_api, job_count)
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_CreateJobs(%p, %u, %p, %p, %p)", job_api, job_count, job_funcs, job_contexts, out_jobs)
    LONGTAIL_VALIDATE_INPUT(job_api, return EINVAL)
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_AddDependecies(%p, %u, %p, %u, %p)", job_api, job_count, jobs, dependency_job_count, dependency_jobs)
    LONGTAIL_VALIDATE_INPUT(job_api, return EINVAL)
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_AddDependecies(%p, %u, %p)", job_api, job_count, jobs)
    LONGTAIL_VALIDATE_INPUT(job_api, return EINVAL)
    LONGTAIL_VALIDATE_INPUT(job_count > 0, return EINVAL)
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_WaitForAllJobs(%p, %p)", job_api, progressAPI)
    LONGTAIL_VALIDATE_INPUT(job_api, return EINVAL)
    struct BikeshedJobAPI* bikeshed_job_api = (struct BikeshedJobAPI*)job_api;
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_ResumeJob(%p, %u)", job_api, job_id)
    LONGTAIL_VALIDATE_INPUT(job_api, return EINVAL)
    struct BikeshedJobAPI* bikeshed_job_api = (struct BikeshedJobAPI*)job_api;
...
{
    LONGTAIL_LOG(LONGTAIL_LOG_LEVEL_INFO, "Bikeshed_Dispose(%p)", job_api)
